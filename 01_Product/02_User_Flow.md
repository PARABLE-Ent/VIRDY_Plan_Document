...
| 버전 | 날짜 | 변경 내용 |
|------|------|----------|
| 4.2 | 2026-01-29 | 사용자 용어 통일: "세션"→"월드/호스트", 호스트 이전 정책(10분 유예) 반영 |
| 4.1 | 2026-01-29 | 세션 관리 기능 추가: 내 세션 패널, 세션 강제 종료, 동시 세션 제한 처리 |
| 4.0 | 2026-01-29 | 실용성 중심 재구성: 과도한 플로우차트 제거, 텍스트/테이블 기반으로 변경, 핵심 High-Level 플로우만 유지 |
| 3.0 | 2026-01-29 | Mermaid 플로우차트 기반 시각화, 모든 분기 및 에러 케이스 명시 |
| 2.0 | 2026-01-28 | Creator/Manager 역할 구분 명확화, 소셜 기능 추가 |
| 1.0 | 2025-XX-XX | 초기 작성 |
