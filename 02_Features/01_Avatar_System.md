...
**Actor**는 아바타 + 트래커 조합의 단위이다. 1명의 사용자가 여러 Actor를 동시에 운용할 수 있으며, 세션의 수용량은 플레이어 수가 아닌 **총 Actor 수**로 제한된다.

| 항목 | 설명 |
|------|------|
| 개인 Actor 수 | 플랜별 상이 (Free/Starter 1개, Pro 2개, Studio 4개, Enterprise 6개+) |
