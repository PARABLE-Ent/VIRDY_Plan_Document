...
|------|------|---------|-----|--------|------------|
| **대상** | 체험자 | 입문자 | 개인 크리에이터 | 프로덕션 스튜디오 | 기업/대규모 프로덕션 |
| **방 생성** | ❌ | ✅ | ✅ | ✅ | ✅ |
| **방 최대 인원** | - | 2명 | 3명 | 6명 | 10명+ |
| **동시 방 보유** | 0개 | 1개 | 1개 | 1개 | 협의 |
| **매니저 모드** | ✅ | ✅ | ✅ | ✅ | ✅ |
| **Sync 모드** | Live | Live | Live | Live | Live / Ultra |
| **아바타 슬롯** | 5개 | 20개 | 50개 | 50개 | 협의 |
| **아바타 용량 제한** | 200MB/개 | 200MB/개 | 200MB/개 | 200MB/개 | 협의 |
| **월드 용량 제한** | - | 800MB | 800MB | 800MB | 협의 |
| **상업적 사용** | ❌ | ❌ | ✅ | ✅ | ✅ |
...
|------|-----------|-----------|----------|------|
| Free | 5개 | 200MB/개 | - | 체험용, 월드 업로드 불가 |
| Starter | 20개 | 200MB/개 | 800MB | 입문자용 |
...
| 항목 | 상태 | 비고 |
|------|------|------|
| Free 플랜 제한 방식 | 📋 논의 필요 | 워터마크 / 시간 제한 / 기능 잠금 중 선택 |
...
| 플랜별 가격 | 📋 논의 필요 | - |
| Starter 플랜의 정확한 포지셔닝 | 📋 논의 필요 | Free와 Pro 사이 차별점 명확화 |
...
| 항목 | 설명 | 우선순위 |
|------|------|---------|
| **5티어 플랜 구현** | Free/Starter/Pro/Studio/Enterprise | 높음 |
