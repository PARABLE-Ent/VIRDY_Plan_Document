...
| 버전 | 날짜 | 변경 내용 | 작성자 |
|------|------|----------|--------|
| 2.0 | 2026-01-28 | 초기 라이선스 체계 문서 작성 | VIRDY Studio |
| 2.1 | 2026-01-28 | VIRDY_LITE 전면 제거, Standard 단일 빌드로 통합 | VIRDY Studio |
| 3.0 | 2026-01-29 | 4티어 구독 플랜 체계 확정, Sync 모드(Live/Ultra) 추가, 스토리지 개수 기반 정책, Enterprise 시트 모델 추가 | VIRDY Studio |
